...
describe('progress on the page', () => {
  it('lists every pathway, weakest first, and counts what is due', () => {
    ...
    assert.equal(count(html, /class="pp[ "]/g), 14, 'ten pathways, the visual fields since P8, conjugate gaze since P9, language since P10 and involuntary movements since P15');
