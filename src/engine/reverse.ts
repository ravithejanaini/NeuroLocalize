...
export const SITE_NAME: Record<Place, string> = {
  ...
  borderzone_posterior: 'posterior border zone (MCA–PCA), around Wernicke area',
...
const PART_NAME: Record<BrainCompartment, string> = {
  ...
  anterior_borderzone: 'anterior border zone',
  posterior_borderzone: 'posterior border zone',
