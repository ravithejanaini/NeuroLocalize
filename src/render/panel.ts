  ...
  update(f: Findings, bodyModality: SensoryModality, render: RenderKb = RENDER): void {
    ...
    const groups: Group[] = [
      ...
      },
      {
        ...
        body: languageHtml(f),
        note: 'Language is read from the left hemisphere, dominant in most people; how often it is not rises with left-handedness (S108). Neglect is recorded by the side of space, opposite the lesion. Gerstmann signs come from the dominant inferior parietal lobule and mean some or all of the four; the complete tetrad is rare (S128). A border-zone lesion around Broca or Wernicke area spares repetition — the transcortical aphasias (S103). Anosognosia and apraxia are not given a place on purpose: anosognosia follows frontal, parietal, temporal or subcortical damage about equally and is seen in a third of right-hemisphere strokes with hemiplegia at three days but a twentieth at six months (S144, S145); apraxia follows left premotor, supplementary motor, inferior parietal or callosal damage, in about half of left-hemisphere strokes (S146). Not modelled: anomic aphasia, reading, and the four Gerstmann signs apart.',
      },
      {
        title: 'Arm',
        drivers: [
