...
built (`docs/P7-analysis.md`, `docs/P8-analysis.md`, `docs/P9-analysis.md`, `docs/P10-analysis.md`, `docs/P11-analysis.md`). Sources: `docs/SOURCES.md`.
...
2. **Expectations are frozen** — forward cases in `cases.ts`, `boundaries.ts`,
   `plexus.ts`, `leg.ts`, `brain.ts`, `vision.ts`, `language.ts` and `cerebellum.ts`; reverse cases in `reverse.ts`,
   `reverse-plexus.ts`, `reverse-leg.ts`, `reverse-brain.ts`, `reverse-vision.ts`, `reverse-language.ts` and `reverse-cerebellum.ts`. A file in
