...
built (`docs/P7-analysis.md`, `docs/P8-analysis.md`, `docs/P9-analysis.md`, `docs/P10-analysis.md`, `docs/P11-analysis.md`, `docs/P12-analysis.md`, `docs/P13-analysis.md`, `docs/P14-analysis.md`). Sources: `docs/SOURCES.md`.
...
2. **Expectations are frozen** — forward cases in `cases.ts`, `boundaries.ts`,
   `plexus.ts`, `leg.ts`, `brain.ts`, `vision.ts`, `language.ts`, `cerebellum.ts`, `posterior.ts`, `midbrain.ts` and `nerves.ts`; reverse cases in `reverse.ts`,
   `reverse-plexus.ts`, `reverse-leg.ts`, `reverse-brain.ts`, `reverse-vision.ts`, `reverse-language.ts`, `reverse-cerebellum.ts`, `reverse-posterior.ts`, `reverse-midbrain.ts` and `reverse-nerves.ts`. A file in
